      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center px-6 py-12">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            >
              The first AI assistant built exclusively for trucking. Answer calls, qualify carriers, and book loads —
              automatically.
            </motion.p>
            ...
            >
              <Button
                asChild
                size="lg"
                className="gap-2 h-16 px-10 text-lg bg-[hsl(25,95%,53%)] hover:bg-[hsl(25,95%,48%)] shadow-2xl shadow-[hsl(25,95%,53%)]/30"
              >
                <Link to="/demo">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="gap-2 h-16 px-10 text-lg bg-white/10 border-white/30 text-white hover:bg-white/20"
              >
                <Link to="/auth">
                  Get Started Free
            ...
            >
              <p className="text-white/40 text-sm uppercase tracking-widest mb-6">
                Trusted by dispatch teams nationwide
              </p>
  ...
  const features = [
    {
      ...
      description:
        "AI answers every call instantly, qualifies carriers, captures intent, and routes hot leads to your team.",
      stat: "100%",
  ...
  const audiences = [
    {
      ...
      description:
        "Scale your brokerage without scaling your team. Let AI handle carrier qualification while you focus on building shipper relationships.",
    ...
    },
    {
      ...
      title: "Dispatchers",
      description:
        "Stop juggling phone calls. AI captures every inquiry, prioritizes callbacks, and gives you the intel to close faster.",
    ...
    },
    {
      ...
      description:
        "Get your trucks loaded faster. Our AI connects you with the right loads and dispatchers who are ready to book.",
    ...
    },
    {
      ...
      description:
        "Focus on driving while AI handles your dispatch communications. Get notified about the loads that match your lanes.",
  ...
  const steps = [
    {
      ...
      description:
        "A carrier sees your load posting and calls. Your AI assistant answers instantly, in their language.",
    },
    {
      step: "02",
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        const response = await fetch("https://vjgakkomhphvdbwjjwiv.supabase.co/functions/v1/public-stats");
    ...
    <section ref={ref} className="py-24 lg:py-32 px-6 bg-[hsl(25,95%,53%)]">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="text-center mb-16"
        >
          <h2 className="font-serif text-4xl md:text-5xl font-medium text-white mb-4">The Numbers Don't Lie</h2>
          <p className="text-xl text-white/80">Real results from real dispatch teams using Truckinglane.</p>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
              size="lg"
              className="gap-2 h-16 px-12 text-lg bg-[hsl(25,95%,53%)] hover:bg-[hsl(25,95%,48%)] shadow-2xl shadow-[hsl(25,95%,53%)]/30"
            >
              <Link to="/auth">
                Get Started Free
                <ArrowRight className="h-5 w-5" />
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="gap-2 h-16 px-12 text-lg bg-white/5 border-white/20 text-white hover:bg-white/10"
            >
              <Link to="/demo">
                <Play className="h-5 w-5" />
                Watch Demo
          ...
          <p className="mt-8 text-white/40 text-sm">No credit card required • Free 14-day trial • Cancel anytime</p>
        </motion.div>
      </div>
    </section>
  );
