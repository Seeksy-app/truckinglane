    ...
    <>
      ...
      {isSuperAdmin && isImpersonating && (
        <div className="bg-amber-500/10 border-b border-amber-500/30">
          <div className="w-full max-w-screen-2xl mx-auto tl-page-gutter py-2 flex items-center justify-between">
      ...
      <header className="border-b border-border bg-card">
        <div className="w-full max-w-screen-2xl mx-auto tl-page-gutter py-3 flex items-center justify-between">
          {/* Logo & Nav */}
