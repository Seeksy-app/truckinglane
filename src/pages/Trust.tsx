...
export default function Trust() {
  ...
  if (step === "email" || step === "code") {
    return (
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-secondary/30 flex items-center justify-center tl-page-gutter">
        <motion.div
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-accent/5 py-24 tl-page-gutter">
      ...
      {/* What It Does */}
      <section className="py-20 tl-page-gutter bg-card/50">
      ...
      {/* How It Works */}
      <section className="py-20 tl-page-gutter">
        <div className="max-w-5xl mx-auto">
      ...
      {/* Footer */}
      <footer className="py-12 tl-page-gutter border-t border-border">
        <div className="max-w-5xl mx-auto text-center">
