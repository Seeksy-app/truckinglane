-- =====================================================
-- CANONICAL METRICS RPC: Single source of truth
-- All Analytics, Reports, and Dashboard must use this
-- =====================================================
...
BEGIN
  ...
  -- Update high intent count from leads too
  SELECT GREATEST(v_high_intent_count, COUNT(*))
  ...
  -- Ensure engaged >= leads (canonical invariant)
...
GRANT EXECUTE ON FUNCTION public.get_metrics_summary(uuid, uuid, timestamptz, timestamptz) TO authenticated;